...
public final class DrawLottery
  ...
  //necessary main to use Processing to draw 
   public static void main(String[] args) {
        ...
        Player player = new Player(PlayerKind.WELL_PAID, 13400);

//        player.playRandom();
//       System.out.println(player.getNumLottos());
//       Game game = new Game();
//       game.winningLotNumber();
//       int numOfMatches = game.match(player.getNumLottos());
//       System.out.println(game.getWinNum());
//       System.out.println(numOfMatches);
//       CommunityLSim com = new CommunityLSim(30);
//       com.reDoWhoPlays();
//       System.out.println(com.getWhoPlay());
    }
}
