...
public interface Entity extends Image
{
   Point getPosition();
...
private void transformFull(WorldModel world, EventScheduler scheduler, ImageStore imageStore)
                                      ...
                                      WorldModel world, ImageStore imageStore)
   {
      switch (this.kind)
      {
         ...
         case ATLANTIS:
            scheduler.scheduleEvent(this, Animation.createAnimationAction(this, ATLANTIS_ANIMATION_REPEAT_COUNT), this.getAnimationPeriod());
            break;
