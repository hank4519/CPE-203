...
//      }
   ...
   public void testExercise6()
   {
      ...
      //Bit Operate, 2 is 0010, (2&1) == 0, then it will be retained; 4 is 0100, it will also be retained.
   ...
   public void testExercise7()
   {
      ...
      //We filter it first using bit operate, and we pass the filtered List and a defined function
      //as argument for map it, x-> x * x and x -> (x&1) == 0 are lambda expressions
