...
final class WorldModel
{
   ...
   private Set<Pirate> pirates = new HashSet<>();
   ...
   public boolean notFarAway(Entity e1, Entity e2){
      return e1.getPosition().notFarAway(e2.getPosition());
   }
   ...
   public void movePirate(Pirate pirate, Point pos){
      Point oldPos = pirate.getPosition();
      if(withinBounds(pos) && !pos.equals(oldPos)){
         setOccupancyCell( oldPos, null);
         removeEntityAt( pos);
         setOccupancyCell(pos, pirate);
         pirate.setPosition(pos);
      }
   }
   public void moveSeahorse(Seahorse seahorse, Point pos){
      Point oldPos = seahorse.getPosition();
      if(withinBounds(pos) && !pos.equals(oldPos)){
         setOccupancyCell( oldPos, null);
         removeEntityAt( pos);
         setOccupancyCell(pos, seahorse);
         seahorse.setPosition(pos);
      }
   }
